...
import com.kokomusoft.exploraticul.ListAdapters.RestaurantAdapter;
...
public class RestaurantListFragment extends ListFragment {
    ...
    private ArrayList<Restaurant> getRestaurants(){
        ...
        restaurant = new Restaurant(getResources().getDrawable(R.drawable.zap02), "Comida Regional",
                "Zoo tycon", "C 26 x 15 y 17 #123D",2);
        restaurants.add(restaurant);
        restaurant = new Restaurant(getResources().getDrawable(R.drawable.zap03),
                "Mariscos","Bella brand", "C 26 x 15 y 17 #123D",3);
        restaurants.add(restaurant);
        restaurant = new Restaurant(getResources().getDrawable(R.drawable.zap02),"Comida Regional",
        ...
        restaurant = new Restaurant(getResources().getDrawable(R.drawable.superior_room2),
                "Buffet y parrillada", "Clarsie shoe Stores", "C 26 x 15 y 17 #123D",6);
        restaurants.add(restaurant);
    ...
    private void setAdapter(ArrayList<Restaurant> restaurants){
