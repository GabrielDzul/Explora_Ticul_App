 ...
 */
public class RestaurantDetailActivity extends ActionBarActivity implements
        RestaurantDetailFragment.OnFragmentSendText{
    ...
    public void onSendText(String text) {
        ...
        if (webViewFragment != null){
            ...
            FragmentTransaction transaction = getFragmentManager()
                    .beginTransaction();
            transaction.replace(R.id.restaurant_detail_container, viewFragment, "webViewFragment")
                    .addToBackStack(null)
                    .commit();
        }
    }
